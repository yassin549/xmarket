 ...
 */
function registerExecutor(jobType, executor) {
    executors[jobType] = executor;
    console.log("Registered executor for job type: ".concat(jobType));
}
/**
 * Execute a job by dispatching to the appropriate executor
 */
function executeJob(jobType, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var executor;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    executor = executors[jobType];
                    if (!executor) {
                        throw new Error("No executor registered for job type: ".concat(jobType));
                    }
                    return [4 /*yield*/, executor.execute(payload)];
